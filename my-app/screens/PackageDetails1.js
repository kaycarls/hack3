...
import { ScrollView, TouchableOpacity, StatusBar, ImageBackground, View, Text, Image, StyleSheet, FlatList, Dimensions } from 'react-native';
import { Linking } from 'react-native';

const { width } = Dimensions.get('window');

const images = [
  require('../assets/ulu1.jpg'),
  require('../assets/ulu2.jpg'),
  require('../assets/ulu3.jpg'),
  require('../assets/ulu4.jpg'),
  require('../assets/ulu5.jpg'),
];
...
const PackageDetails1 = () => {
  ...
  const handleWhatsAppPress = () => {
    Linking.openURL('https://wa.me/6738833123?text=Im%20interested%20in%20this%20package');
  };
    ...
    <ScrollView style={styles.container}>
      ...
      <View style={styles.secondSection}>
        ...
        <Text style={styles.description}>
          Sumbiling Eco Village | Rainforest Discovery | Ulu Temburong National Park | Canopy Walk | Nature Fish Spa | Waterfall
        </Text>
        ...
        <Text style={styles.listItem}>Free & leisure. Relax in the river or take a walk to the village and its surrounding.</Text>
        ...
        <Text style={styles.listItem}>Breakfast & get ready for the day (flexible)</Text>
        <Text style={styles.listItem}>Start Rainforest Discovery trek OR Ulu Temburong National Park</Text>
